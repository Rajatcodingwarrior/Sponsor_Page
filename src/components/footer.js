    ...
    >
      <div className="footer-max-width max-content-container">
        <div className="footer-banner">
          <h1 className="footer-text Heading2">REGISTER NOW FOR Udbhav-2k23</h1>
          <span className="footer-text01">
            <span className=""></span>
            <span className="">get ready for the most insightfull event</span>
          </span>
        ...
        <div className="footer-bottom-container">
          <div className="footer-left-side">
            <span className="footer-text04">
              ...
              eget tincidunt odio, ut rhoncus ligula. In lorem est, venenatis
              sed justo suscipit, varius mollis felis. Suspendisse et massa
              ipsum. Mauris molestie eros mi, id egestas nibh sodales eu. Donec
              porttitor convallis ante. Cras bibendum, erat at suscipit
              vehicula, quam quam congue urna, ut sodales quam ligula vitae
              arcu. Vivamus vehicula eleifend commodo. In finibus porta turpis
              ac euismod. 
            </span>
            <div className="footer-social-media">
              <span className="footer-text05">Follow market1</span>
          ...
          <div className="footer-links">
            ...
            <div className="footer-container2">
              ...
              <span className="footer-text17 footer-link">sales</span>
            </div>
          </div>
        </div>
